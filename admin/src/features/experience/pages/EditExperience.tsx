...
import { getExperienceById, updateExperience, clearExperienceState } from "@/features/experience/experienceSlice"
...
const EditExperience = () => {
    ...
    const { experience, loading } = useSelector((state: RootState) => state.experiences)
    ...
    useEffect(() => {
        if (experience) {
            ...
            setWorkMode((experience.workMode as any) || "Onsite")
            ...
            setIsOngoing(!!experience.isOngoing)
    ...
    const handleSubmit = async () => {
        ...
        try {
            await dispatch(updateExperience({ id, data: formData })).unwrap()
    ...
    if (loading && !experience) return <div className="text-center py-10">Loading...</div>
        ...
        <div className="py-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    ...
                    <div className="space-y-1">
                        ...
                        <Input
                            placeholder={workMode === "Remote" ? "Remote" : "City, Country"}
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                <Button variant="outline" disabled={isOngoing} className="w-full justify-start">
                                    <CalendarIcon className="mr-2 h-4 w-4" />
            ...
            <Card>
                ...
                <CardContent className="space-y-2">
                    ...
                    {logoPreview && (
                        <img src={logoPreview} alt="Logo Preview" className="w-32 h-32 rounded-md border" />
                    )}
                </CardContent>
            </Card>
