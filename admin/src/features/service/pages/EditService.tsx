    ...
    <div className="py-6 grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <Card>
        ...
        <CardContent>
          <Input
            className="h-12"
            placeholder="Ex: Development, Design"
      ...
      <Card className="md:col-span-2">
        ...
        <CardContent className="space-y-4">
          {formData.features.map((feature: any, index: number) => (
            <div key={index} className="grid grid-cols-1 md:grid-cols-12 gap-4 items-start border p-4 rounded-xl bg-slate-50/50">
              <div className="md:col-span-1 text-slate-400 font-bold p-2">{index + 1}</div>
